...
def add_studio_lights():
	...
	util_helper.move_to_scene_collection(obj_light_top)
	util_helper.move_to_scene_collection(obj_light_side)
	util_helper.move_to_scene_collection(obj_light_back)

	util_helper.move_to_scene_collection(camTarget)
